        ...
        <div class="w-full max-w-7xl mx-auto px-4 lg:px-8 xl:px-14">
            <div class="flex  items-center justify-between gap-3 mb-5">
                <div class="flex items-center gap-4">
                    <h5 class="text-xl leading-8 font-semibold text-gray-900">{{ currentMonthYear }}</h5>
            ...
            <div class="border border-gray-200">
                <div class="grid grid-cols-7  divide-gray-200 border-b border-gray-200">
                    <CalendarHead :markDate="markDate" />
                </div>
                <div class="grid grid-cols-7 divide-gray-200">
                    <CalendarDay :markDate="markDate" />
                </div>
            </div>
...
<script setup>
import CalendarDay from '../materials/CalendarDay.vue';
import CalendarHead from '../materials/CalendarHead.vue';
import { format } from "date-fns";
import { ref } from 'vue';
const markDate = ref(new Date());
function resetDate() {
    markDate.value = new Date();
    currentMonthYear.value = format(markDate.value, 'MMMM yyyy')
}
function changeMonth(step) {
    markDate.value = new Date(markDate.value.getFullYear(), markDate.value.getMonth() + step, 1)
    currentMonthYear.value = format(markDate.value, 'MMMM yyyy')
}

const currentMonthYear = ref(format(markDate.value, 'MMMM yyyy'));
